...
const SNOWFLAKES_COUNT_FOR_HOME_AND_GAME_PAGE = 50;
const SNOWFLAKES_COUNT_FOR_TOYS_PAGE = 100;

const GARLANDS = ['off', 'multicolored', 'red', 'blue', 'green', 'yellow'];

const FIRST_GARLAND_COUNT = 5;
const SECOND_GARLAND_COUNT = 7;
const THIRD_GARLAND_COUNT = 11;
const FOURTH_GARLAND_COUNT = 15;
...
export {
  ...
  GARLANDS,
  FIRST_GARLAND_COUNT,
  SECOND_GARLAND_COUNT,
  THIRD_GARLAND_COUNT,
  FOURTH_GARLAND_COUNT,
};
